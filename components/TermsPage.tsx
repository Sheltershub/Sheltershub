    ...
    <div className="bg-gray-50 dark:bg-slate-dark-950 min-h-screen font-sans transition-colors duration-300">
      ...
      <div className="bg-white dark:bg-slate-dark-900 border-b border-gray-200 dark:border-slate-dark-800">
        <div className="container mx-auto px-4 py-12 text-center">
            <h1 className="text-3xl font-bold text-[#0A2B4C] dark:text-white mb-2">Terms &amp; Conditions</h1>
            <p className="text-gray-500 dark:text-gray-400 text-lg max-w-2xl mx-auto">Please read these terms carefully before using Sheltershub.</p>
        </div>
      </div>

      <main className="container mx-auto px-4 py-16 max-w-4xl">
        
        <div className="bg-white dark:bg-slate-dark-900 rounded-xl border border-gray-200 dark:border-slate-dark-800 shadow-sm p-8 md:p-12 space-y-10 text-gray-700 dark:text-gray-300 leading-relaxed">
            
            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">1. Introduction</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">2. Eligibility</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">3. User Responsibilities</h2>
            ...
            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">4. Property Listings</h2>
                <p className="mb-3">
            ...
            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">5. Payments &amp; Subscriptions</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">6. Privacy Policy Reference</h2>
                <p>
                    Your privacy is important to us. Please review our <a href="#" className="text-[#F9A826] dark:text-brand-orange hover:underline">Privacy Policy</a> to understand how we collect, use, and protect your personal data. By using Sheltershub, you consent to our data practices.
                </p>
            </section>

            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">7. Intellectual Property</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">8. Limitation of Liability</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">9. Termination of Accounts</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-[#0A2B4C] dark:text-white mb-4 pb-2 border-b border-gray-100 dark:border-slate-dark-800">10. Governing Law</h2>
                <p>
        ...
        <div className="mt-12 text-center">
            ...
            <button 
                ...
                className="px-8 py-3 bg-[#0A2B4C] dark:bg-brand-blue text-white font-bold rounded-lg hover:bg-[#08223c] dark:hover:bg-brand-blue-dark shadow-md transition-all hover:shadow-lg"
            >
                Back to Home
            </button>
        </div>
